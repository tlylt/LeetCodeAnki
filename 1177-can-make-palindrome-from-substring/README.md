<h2><a href="https://leetcode.com/problems/can-make-palindrome-from-substring/">1177. Can Make Palindrome from Substring</a></h2><h3>Medium</h3><hr><div><p>You are given a string <code>s</code> and array <code>queries</code> where <code>queries[i] = [left<sub>i</sub>, right<sub>i</sub>, k<sub>i</sub>]</code>. We may rearrange the substring <code>s[left<sub>i</sub>...right<sub>i</sub>]</code> for each query and then choose up to <code>k<sub>i</sub></code> of them to replace with any lowercase English letter.</p>
